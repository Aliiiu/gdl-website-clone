            ...
            <div className="flex gap-10 items-center">
              <div className="flex gap-10 items-center">
                ...
                <div className="flex flex-col items-left">
                  ...
                  <p className="text-white max-w-[340px] my-2">
                  ...
                  >
                    <span className="bg-white w-fit rounded-lg px-5 py-2.5 text-[#992333] font-thin flex items-center gap-x-1 cursor-pointer">
