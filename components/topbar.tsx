...
import MenuClose from "../assets/svgs/menu-close";
import {
  IoBriefcaseOutline,
  IoBulbOutline,
  IoCallOutline,
...
const Topbar = () => {
  ...
  return (
    <header
      className={
        "z-30 sticky top-0 right-0 left-0 border-gray-200 w-full transition ease-in-out duration-500"
      }
    >
      <Transition
        show={open}
      ...
      >
        <div className="data-[closed]:opacity-0 transform opacity-100">
          <Transition.Child
            as="div"
            className="bg-[#1F1A17] bg-opacity-80 top-0 left-0 mt-[60px] right-0 bottom-0 fixed h-[100vh] overflow-y-scroll data-[closed]:opacity-0"
          ...
          >
            <div className="flex bg-white w-full rounded-lg">
              <ul className="w-2/5 md:w-1/4 mt-[1rem] h-full border-r-[1px] border-opacity-[0.1] border-[rgba(194,207,214,var(--tw-border-opacity))]">
          ...
          <nav className="py-2 z-20 top-0 left-0">
            <div className="w-full flex justify-between items-center mx-auto">
              <div className="flex items-center">
                <div className="flex items-center gap-4 lg:justify-start justify-between">
                  <button
                    ...
                    type="button"
                    className="hidden lg:inline-flex items-center lg:p-2 lg:px-0 p-0 text-sm text-black rounded-lg focus:outline-none focus:ring-0 focus:ring-gray-200"
              ...
              <button
                data-collapse-toggle="navbar-sticky"
                type="button"
                className="lg:hidden inline-flex items-center lg:p-2 lg:px-0 p-0 text-sm text-black rounded-lg focus:outline-none focus:ring-0 focus:ring-gray-200"
                aria-controls="navbar-sticky"
                aria-expanded="false"
                onClick={() => setOpen(!open)}
              >
