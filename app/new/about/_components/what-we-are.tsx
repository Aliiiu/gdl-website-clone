					...
					<div className="flex-1">
						<div className="max-w-lg mb-8 md:mb-0 mx-auto">
							...
							<p className="max-w-lg leading-loose">
								We walk our talk. We embrace excellence and professionalism in
								all we do and build careers not jobs. We relate with all
								internal and external stakeholders with mutual respect based on
