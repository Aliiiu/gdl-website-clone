	...
	<div className="px-[1.5rem] max-w-[1200px] mx-auto">
		<div className="max-w-[500px]">
			...
			<div className="relative rounded-[0.5rem] bg-opacity-100 bg-[rgba(255,255,255,var(--tw-bg-opacity))] h-[50px] shadow">
				...
				<button
					type="button"
					className="absolute top-0 right-0 bottom-0 mr-4 flex items-center justify-center text-[1.25rem] leading-[1.75rem] text-[rgba(31,26,23,var(--tw-text-opacity))] text-opacity-[0.5]"
				>
					<IoSearchOutline />
				</button>
			</div>
