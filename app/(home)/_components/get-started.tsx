  ...
  return (
    <section id="get-started" className="lg:w-4/6 mx-auto pt-20 -mb-20 w-full">
      <div className="flex justify-center">
        <div className="flex flex-col md:flex-row max-w-4xl mx-auto overflow-hidden md:rounded-lg shadow-2xl bg-get-started-image bg-no-repeat bg-coverbg-center">
          <div className=" md:w-[50%] p-6 xl:p-12 bg-primary/50">
